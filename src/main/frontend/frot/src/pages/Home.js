...
import playerHeader from '../images/playerHeader.PNG';
...
useEffect(() => {
  ...
  return (
    <Box sx={{ backgroundColor: "#F4F4F4", maxWidth: "none"}}>
      {/* 첫 번째 AppBar */}
...
<Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', px: 2, py: 2, minHeight: '50px' }}>
  <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 2 }}>
              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(0)}>
                마이 페이지
              </Button>
              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(1)}>
                내 팀 목록
              </Button>
              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(2)}>
                팀 찾기
              </Button>
              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(3)}>
                팀 관리
              </Button>
              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(4)}>
                팀 생성
              </Button>

              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(5)}>
                경기 참가 글 생성
              </Button>

              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(6)}>
                내 팀 글목록
              </Button>

              <Button variant="text" color="info" size="large" sx = {{fontSize: '1.0rem', color : '#FF6F00'}} onClick={() => setActiveTab(7)}>
                내 경기 스케줄
              </Button>
            </Box>


    <Box sx={{ position: 'absolute', top: 0, right: 1, py: 3 }}>
      ...
      <Box sx={{
      backgroundImage: `url(${playerHeader})`,
      backgroundSize: 'cover',
      backgroundRepeat: 'no-repeat',
      backgroundPosition: 'center',
      borderRadius: '12px',
      padding: '50px 20px', // 상하 여백을 넉넉하게 줌
      minHeight: '600px',   // 기본 높이 지정
      display: 'flex',
